...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $deleteQuery = "DELETE FROM accounts WHERE account_name = '$accountName' AND user_name = '$userName'";

    if (mysqli_query($conn, $deleteQuery)) {
        echo "Password deleted successfully from Safe!";
    } else {
        echo "Error encountered when deleting password, Please try again!: " . mysqli_error($conn);
    }
}
?>
